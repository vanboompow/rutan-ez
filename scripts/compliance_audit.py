...
def run_compliance_audit():
    ...
    compliance_tracker.complete_task("wing_cores_right", ManufacturingMethod.BUILDER_CNC)
    compliance_tracker.complete_task("wing_skins_left", ManufacturingMethod.BUILDER_MANUAL)
    compliance_tracker.complete_task("wing_skins_right", ManufacturingMethod.BUILDER_MANUAL)
