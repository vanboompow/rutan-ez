...
See `docs/architecture-roadmap.md` for the planned extensions that enable 3D-printed fixtures, CNC-ready toolpaths, and physics-backed validation pipelines.
